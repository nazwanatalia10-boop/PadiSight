...
if img_base64:
  ...
  [data-testid="stSidebar"] > div:first-child {{
    ...
    sidebar_bg = "[data-testid=\'stSidebar\'] { background-color: #0f1c14; }"
...
<style>
  ...
  /* Sembunyikan radio button bulat asli */
...
if menu == "🏠 Beranda":
    st.markdown("""
        <div style='padding:8px 0 6px'>
            ...
            <h1 style='font-size:2rem; font-weight:800; letter-spacing:-1px; margin:6px 0'>
                Prediksi <span style='color:#1a6b3c'>Produktivitas</span> Padi Indonesia
            </h1>
            <p style='color:#4a6355; font-size:0.92rem; max-width:520px; line-height:1.6; margin:0'>
